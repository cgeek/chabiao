...
?>
	...
	<p>
		<a class="btn" href="/admin/sites/add">网站列表</a>
	...
	<div class="site-list">
			...
			<?php foreach($site_list as $site):?>
				<tr class="site_id_<?=$site['id'];?>">
                  <td><?=$site['id'];?></td>
				  <td><a href="http://<?=$site['domain'];?>" target="_blank"><?=cut_str($site['domain'], 30);?></a></td>
                  <td><?=$site['name'];?></td>
                  <td><?=cut_str($site['keywords'], 30);?></td>
 				  <td><?=date('Y-m-d',$site['mtime']);?></td>
				  <td><a href="sites/edit?id=<?=$site['id'];?>">修改</a> | <a class="delete_site_btn" site_id="<?=$site['id'];?>" href="sites/delete?id=<?=$site['id'];?>">删除</a></td>
                </tr>
			<?php endforeach;?>
              </tbody>
            </table>
